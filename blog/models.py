...
class Gallery(models.Model):
    ...
    photo_large = models.ImageField(null=True, blank=True,upload_to="images/", help_text="1400X1000",default="")
...
class Profile(models.Model):
    name = models.CharField(max_length=50,default="")
    phone_num = models.CharField(max_length=50,null=True,blank=True, default="")
    job = models.CharField(max_length=50,default="")
    photo_small = models.ImageField(null=True, blank=True,upload_to="images/",help_text="300X300")
...
class Category(models.Model):
    ...
    description = models.CharField(max_length=255, help_text="short text describe this category", default="", null=True, blank=True)
...
class Post(share_models.PostTypeModel):
    category = models.ForeignKey(Category,null=True,default=None,blank=True, on_delete=models.SET_NULL)
    pop_in_banner = models.BooleanField(default=False)
    slug = models.SlugField(unique=True)
    read_time = models.IntegerField(blank=True, help_text="Time to read (Unit:minutes)")
    tags = TaggableManager(blank=True)
    view_count = models.IntegerField(default=0)
    photo = models.ForeignKey(Gallery, default=None,blank=True,null=True, on_delete=models.SET_NULL)
...
class Like(models.Model):
    ...
    like = models.ForeignKey(Post, related_name="like", on_delete=models.CASCADE, null=True)
